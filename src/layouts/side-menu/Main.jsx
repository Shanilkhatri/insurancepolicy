...
import { sideMenu as useSideMenuStore, usersideMenu as userSideMenuStore } from "@/stores/side-menu";
...
function Main() {
  ...
  const usersideMenu = () => nestedMenu($h.toRaw(UsersideMenuStore.menu), location);
  ...
  return (
    ...
    {userType == "admin" && <div className="py-2">
      <DarkModeSwitcher />
      <MainColorSwitcher />
      {/* <MobileMenu /> */}
    ...
    {userType == "user" && <div className="py-2">
      <DarkModeSwitcher />
      <MainColorSwitcher />
      {/* <MobileMenu /> */}
      <div className="flex mt-[4.7rem] md:mt-0">
